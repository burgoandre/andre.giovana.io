...
<head>
	...
	<title>Casamento de Giovana e André</title>
  ...
  <link rel="stylesheet" href="css/slick.css?v=1670862206">
  <link rel="stylesheet" href="css/slick-theme.css?v=1670862205">
  <link rel="stylesheet" href="css/jquery.fancybox.min.css?v=1670862205">
  <link rel="stylesheet" href="css/addEvent.css?v=1670862204">
  <link rel="stylesheet" href="css/style.css?v=1670862206">
  <link rel="stylesheet" href="css/responsive.css?v=1670862205">
	...
	<link rel="icon" sizes="16x16 32x32 64x64" href="img/favicon/favicon1.ico">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <p>
          ...
          Bem vindo ao convite de
          Giovana
          e
          André        </p>

        <span>A música de fundo faz parte da experiência</span>

        <br>
        <a class="boton" id="play-music-modal" href="">Entrar com música</a>
        <a class="boton" data-dismiss="modal" aria-label="Close" id="" href="">Entrar sem música</a>
      </div>
    ...
    <div class="row d-flex justify-content-center align-items-center">
      ...
      <div class="content-portada text-center">
        ...
        <div class="box-frase-portada">
          <p>
            <img src="img/comilla-apertura.svg" alt=""> <br>

            Assim, eles já não são dois, mas sim uma só carne.<br>Portanto,
			o que Deus uniu, ninguém separa.<br>
...
<section class="cuenta-regresiva">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-ceremonia text-center">
        ...
        <div class="info-col">
          ...
          <div class="info-box">
            <h6>Dia</h6>
            <p>Sábado, 23 de Novembro - 11hs</p>
            <a href="#" class="boton addeventatc">

              <span class="nameBtn">Agendar</span>

              <span class="start">2024-11-23 11:00:00</span>
              <span class="end">2024-11-23 12:00:00</span>
              <span class="timezone">America/Sao_Paulo</span>
              <span class="title">Casamento de Giovana e André (Cerimônia)</span>
          ...
          <div class="info-box">
            <h6>Local</h6>
            <p>Capela de Santo Antônio - Jahu/SP</p>
           <!-- <a href="#" data-evento="Ceremonia" class="boton confirmar-asistencia">Confirmar presença</a> -->
          </div>

          <div class="info-box">
            <h6>Endereço</h6>
            <p>Rua Gomes Botão, 441 - Santo Antonio - Jaú/SP </p>
            <a href="#" data-evento="Ceremonia" class="boton modal-como-llegar">Como chegar?</a>
          </div>
      ...
      <div class=" col-md-6 col-fiesta text-center">
        ...
        <div class="info-col">
          ...
          <div class="info-box">
            <h6>Dia</h6>
            <p>Sábado 15 de Maio - 20hs</p>
            <a href="#" class="boton addeventatc">
              <span class="nameBtn">Agendar</span>

              <span class="start">2024-09-15 20:00:00</span>
              <span class="end">2024-09-15 20:00:00</span>
              <span class="timezone">America/Sao_Paulo</span>
              <span class="title">Casamento de Vítor e Luísa (Festa)</span>
            </a>
          </div>

          <div class="info-box">
            <h6>Local</h6>
            <p>Salão de festas Avril</p>
            <a href="#" data-evento="Fiesta" class="boton confirmar-asistencia">Confirmar presença</a>
          </div>

          <div class="info-box">
            <h6>Endereço</h6>
            <p>Av. Brasil 61 SC</p>
            <a href="#" data-evento="Fiesta" class="boton modal-como-llegar">Como chegar?</a>
          </div>
  ...
  <div class="container">
    ...
    <div class="row text-center d-flex justify-content-center align-items-center">
      ...
      <div class="content-galeria">
        ...
        <h2 class="title">Retratos do nosso amor</h2>
        <p class="subtitle">Um minuto, um segundo, um momento restante na eternidade</p>
  ...
  <div class="container">
    <div class="row text-center d-flex justify-content-center align-items-center">
      ...
      <div class="col-md-12">
        <h2 class="title">Festa</h2>
        <p class="subtitle">Façamos juntos uma festa épica. Aqui, alguns detalhes para levar em conta</p>
      </div>
      ...
      <div class="col-md-4 item-fiesta">
        ...
        <div class="w-100 content-item-fiesta d-flex flex-column justify-content-between align-items-center">
          ...
          <p>
            Qual é a música que não deve faltar na playlist da festa?          </p>

          <a href="#" class="boton sugerir-cancion">Sugerir música</a>
      ...
      <div class="col-md-4 item-fiesta">
        ...
        <div class="w-100 content-item-fiesta d-flex flex-column justify-content-between align-items-center">
          ...
          <div class="d-flex justify-content-center align-items-center content-anim-fiesta">
            <div class="anim-vestuario"></div>
          </div>

          <p>
            Uma orientação para o traje do evento          </p>

          <a href="#" class="boton modal-vestuario">
            Ver mais          </a>
      ...
      <div class="col-md-4 item-fiesta">
        ...
        <div class="w-100 content-item-fiesta d-flex flex-column justify-content-between align-items-center">
          ...
          <p>
            Informação adicional para levar em conta          </p>


          <a href="#" class="boton  modal-tips">
            Ver mais          </a>
  ...
  <div class="container">
    <div class="row text-center d-flex justify-content-center align-items-center">
      ...
      <p class="subtitle">Se você quiser nos dar algo mais do que sua linda presença ...</p>
      ...
      <a href="#" class="boton modal-regalos">Pix</a>
  ...
  <div class="container">
    <div class="row text-center d-flex justify-content-center align-items-center">
      ...
      <h2 class="title">Nós compartilhamos este dia com você</h2>
      <p class="subtitle">Compartilhe suas fotos e vídeos desse lindo dia</p>
      ...
      <div class="w-100">
        ...
        <a target="_blank" href="https://www.instagram.com/" class="hashtag">#gieandre</a>

      </div>

      <br>

      <a target="_blank" href="https://www.instagram.com/" class="boton">Veja no Instagram</a>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-acciones-footer d-flex justify-content-center justify-content-md-start align-items-center">

        <ul>

          <li>
            <a href="#" data-evento="Ceremonia" class="confirmar-asistencia">Confirmar presença na cerimônia</a>
          </li>

          <li>
            <a href="#" data-evento="Fiesta" class="confirmar-asistencia">Confirmar presença na festa</a>
          </li>

          <li>
            <a href="#" class="sugerir-cancion">Sugerir música</a>
          </li>

          <li>
            <div title="" class="addeventatc">

              <span class="nameBtn">Salvar data da festa</span>
          ...
          <li>
            <div title="" class="addeventatc">
              ...
              <span class="nameBtn">Salvar data da cerimônia</span>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <p>
          Desenvolvido com <span class="heart">&#129505;</span> pelo <strong>Noivo</strong>
        </p>
...
<!-- Musica -->
  ...
  <div id="controlador-musica">
    <div id="play-pause-music" data-estado-music="pause" class="music-anim-icon"></div>
  </div>
...
<!-- Si esta en modo "Modelo" muestro el repdorductor de musica sin musica -->
        ...
        <div class="formulario-content">
          ...
          <form id="formAsistencia" action="">
            ...
            <div class="form-group">
              <input type="text" class="form-control" id="nombreAsistente" name='nombre' placeholder="Nome completo">
            </div>


            <div class="form-group">
              <textarea id="comentariosAsistente" class="form-control" name="comentarios" id="" rows="2" placeholder="Insira qualquer informação importante, por exemplo: Eu sou vegetariano"></textarea>
            </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5 class="modal-title">Sugerir música</h5>
      ...
      <div class="modal-body">
        ...
        <div class="formulario-content">
          ...
          <form id="formSugerirCancion" action="">
            ...
            <div class="form-group">
              <input type="text" class="form-control" id="nombreSugerencia" name='nombre' placeholder="Seu nome">
            </div>

            <div class="form-group">
              <input type="text" class="form-control" id="descripcionSugerencia" name='descripcion' placeholder="Nome e autor da música">
            </div>

            <div class="form-group">
              <input type="text" class="form-control" id="linkSugerencia" name='link' placeholder="Se desejar, insira o link do Youtube, Spotify, etc.">
            </div>
      ...
      <div class="modal-footer">
        <button type="button" id="sendSugerenciaCancion" class="boton">Sugerir música</button>
      </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="img-top-modal d-flex justify-content-center align-items-start">
        ...
        <div class="white-circle-icon">
          <img class="" src="img/vestuario.svg" alt="">
        </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5 class="modal-title">Dicas e Notas</h5>

      </div>

      <div class="modal-body">

        <p>Conteúdo Dicas e Notas</p>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5 class="modal-title">Chave PIX</h5>

      </div>

      <div class="modal-body">
      </div>
		André - 403.015.238-43<br>
		Giovana - 461.035.668-60
      <div class="modal-footer">
      </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a class="boton ampliar-mapa" target="_blank" href="#">Ampliar mapa</a>
      </div>
    ...
    <!-- Modal cambio de idioma -->
      ...
      <!-- Modal -->
<div class="modal fade modal-transparent" id="modal-lang" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
...
<script>
  ...
  var _pathProducto = "https://burgoandre.github.io/andre.giovana.io/";
  ...
  // Idioma js en MODELO e INVITACION
    ...
    // Cuenta regresiva
    var fechaCuentaRegresiva = "11/23/2024 11:00:00";

    // Mapas
    var latitudFiesta = -22.302659752152127;
    var longitudFiesta = -48.55939907709004;
    var latitudCeremonia = -22.302659752152127;
    var longitudCeremonia = -48.55939907709004;
...
<script type='text/javascript' src='langs/js/pt-BR.js?v=1670865729'></script><script type='text/javascript' src='js/jquery-3.5.1.min.js?v=1670862235'></script><script type='text/javascript' src='js/jquery.cookie.js?v=1645580925'></script><script type='text/javascript' src='js/change-lang.js?v=1645580924'></script><script type='text/javascript' src='js/waypoint/noframework.waypoints.min.js?v=1670865716'></script><script type='text/javascript' src='js/parallax.min.js?v=1670862237'></script><script type='text/javascript' src='js/popper.min.js?v=1670862237'></script><script type='text/javascript' src='js/bootstrap.min.js?v=1670862235'></script><script type='text/javascript' src='js/slick.min.js?v=1670862238'></script><script type='text/javascript' src='js/jquery.fancybox.min.js?v=1670862236'></script><script type='text/javascript' src='js/scripts.js?v=1670862237'></script>
...
<script>
  ...
  <!-- Api Maps-->
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC_3ZK1od6HtymslnbVFuzpUbMfrCRVqzM&callback=initMap&r=1728091090">
  </script>
